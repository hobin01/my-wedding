...
window.CONFIG = {
  ...
  date: {
    datetime: '2026-01-01T16:00:00+09:00',
  },
...
감사하겠습니다.`,
  ...
  transport: [
    ...
    { label: '셔틀버스', icon: 'S', detail: '예식시간 1시간 전부터 30분 간격으로 셔틀버스 이용 가능' },
    { label: '자가용', icon: 'P', detail: '무료주차가 가능한 편리하고 넓은 지상주차장' },
  ],

  // ── 추가 주문 셔틀버스 — 탑승 정보 ────────────────────────────────────────
  // 지도는 표시하지 않습니다. label/time/place/route/note 값만 수정하면 화면에 반영됩니다.
  // 빈 배열이면 "하 객 버 스" 섹션 자체가 표시되지 않습니다.
  rentalBuses: [
    {
      label: '1호차',
      route: '서울역 → 비렌티 웨딩홀',
      time: '2026년 1월 1일 오후 1시 30분',
      place: '서울역 14번 출구 앞 대형버스 정차 구역',
      note: '출발 10분 전까지 탑승 장소에 도착해 주세요.',
    },
    {
      label: '2호차',
      route: '잠실종합운동장 → 비렌티 웨딩홀',
      time: '2026년 1월 1일 오후 1시 40분',
      place: '잠실종합운동장역 6번 출구 인근 관광버스 승하차장',
      note: '탑승 인원 확인 후 정시에 출발할 예정입니다.',
    },
  ],
